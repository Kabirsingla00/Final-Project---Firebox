...
if (!function_exists('freightco_trx_addons_override_options_fields')) {
	add_filter( 'trx_addons_filter_meta_box_fields', 'freightco_trx_addons_override_options_fields', 10, 2);
	function freightco_trx_addons_override_options_fields($mb, $post_type) {

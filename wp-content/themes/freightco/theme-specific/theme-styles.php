...
.wp-block-button:not(.is-style-outline) > .wp-block-button__link:not(.has-text-color):not(.has-background):focus,
/* BB & Buddy Press */
...
.comments_list > li.pingback a,
.comments_list > li.trackback a{
	color: {$colors['text_link']};
}
.comments_list > li.pingback a:hover,
...
.widget_calendar th, .wp-calendar-table th {
	color: {$colors['alter_link']};
}
...
.content .widget_calendar tbody td a,
.content .wp-calendar-table tbody td a{
	color: {$colors['text_dark']};
}
.content .widget_calendar tbody td a:hover,
.content .wp-calendar-table tbody td a:hover{
	color: {$colors['text_link']};
}
...
.widget_calendar td#today, .wp-calendar-table td#today {
	color: {$colors['inverse_text']} !important;
}
.widget_calendar td#today a, .wp-calendar-table td#today a {
	color: {$colors['alter_hover']};
}
.widget_calendar td#today a:hover, .wp-calendar-table td#today a:hover {
	color: {$colors['alter_link']};
}
.widget_calendar td#today:before, .wp-calendar-table td#today:before {
...
.content .widget_calendar #prev a, .content .widget_calendar #next a,
.content .wp-block-calendar #prev a, .content .wp-block-calendar #next a,
.content .widget_calendar .wp-calendar-nav-prev a, .content .widget_calendar .wp-calendar-nav-next a,
.content .wp-block-calendar .wp-calendar-nav-prev a, .content .wp-block-calendar .wp-calendar-nav-next a {
	color: {$colors['text_dark']};
}

.content .widget_calendar #prev a:hover, .content .widget_calendar #next a:hover,
.content .wp-block-calendar #prev a:hover, .content .wp-block-calendar #next a:hover,
.content .widget_calendar .wp-calendar-nav-prev a:hover, .content .widget_calendar .wp-calendar-nav-next a:hover,
.content .wp-block-calendar .wp-calendar-nav-prev a:hover, .content .wp-block-calendar .wp-calendar-nav-next a:hover {
	color: {$colors['text_link']};
}
...
.content .sc_edd_details .downloads_page_tags .downloads_page_data > a,
.content .widget_product_tag_cloud a, .content .widget_tag_cloud a,

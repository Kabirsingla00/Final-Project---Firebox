				...
				$freightco_comments_args = apply_filters( 'freightco_filter_comment_form_args', array(
						...
						'fields' => array(
							'author' => freightco_single_comments_field(array(
												...
												'field_name' => 'author',
												'field_title' => esc_attr__('Name', 'freightco'),
												'field_placeholder' => esc_attr__( 'Your Name', 'freightco' )
											)),
							'email' => freightco_single_comments_field(array(
												...
												'field_name' => 'email',
												'field_title' => esc_attr__('E-mail', 'freightco'),
												'field_placeholder' => esc_attr__( 'Your E-mail', 'freightco' )
											))
						),
						...
						'comment_field' => freightco_single_comments_field(array(
												...
												'field_value' => '',
												'field_name' => 'comment',
												'field_title' => esc_attr__('Comment', 'freightco'),
												'field_placeholder' => esc_attr__( 'Your comment', 'freightco' )
											)),
				));
